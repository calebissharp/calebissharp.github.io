...
const about = `
  ...
  My name is Caleb Sharp, I'm 15, and I'm a developer. Creating software is
...
const portfolio = `
  ...
  * As of right now, this site is the only (real) thing that I have to prove my skills with.
    It was made from scratch with React, and you can check it out on [GitHub](https://github.com/calebissharp/calebissharp.github.io).
    It would be great if you gave me a chance to show you what I can do! You can
